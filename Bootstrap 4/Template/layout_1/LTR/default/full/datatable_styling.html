			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Alumnos</span> - Lista de Alumnos</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_styling.html" class="breadcrumb-item">Alumnos</a>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							<tr>
								...
								<td>Ingenieria en Tecnologías de la Información</td>
								<td>1930980</td>
							...
							<tr>
								...
								<td><a href="#">Ingenieria en Tecnologías de la Información</a></td>
								<td>1930225</td>
								<td><span class="badge badge-success">Active</span></td>
								<td class="text-center">
									<div class="list-icons">
							...
							<tr>
								<td>Cicely</td>
								<td>Sigler</td>
								<td><a href="#">Ingenieria en Tecnologias de la Información</a></td>
								<td>1930211</td>
								<td><span class="badge badge-success">Active</span></td>
								<td class="text-center">
									<div class="list-icons">
