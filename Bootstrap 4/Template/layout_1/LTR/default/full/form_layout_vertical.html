				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="form_layout_vertical.html" class="breadcrumb-item">Alumnos</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Edita los Datos</h5>
					...
					<div class="card-body">
						<form action="#">
							<div class="row">
								<div class="col-md-6">
									<fieldset>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input type="text" class="form-control" placeholder="José Abrham">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input type="text" class="form-control" placeholder="Martínez Alvarez">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input type="text" class="form-control" placeholder="1930450">
											</div>
										</div>


										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Ingresa tu contraseña:</label>
											<div class="col-lg-9">
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Selecciona tu Estado:</label>
											<div class="col-lg-9">
												<select data-placeholder="Selecciona un Estado" class="form-control form-control-select2" data-fouc>
													<option></option>
													<optgroup label="México Time Zone">
														<option value="AK">Tamaulipas</option>
														<option value="HI">Jalisco</option>
													</optgroup>
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Ingresa tu dirección:</label>
											<div class="col-lg-9">
												<textarea rows="5" cols="5" class="form-control" placeholder="Ingresa tu dirección"></textarea>
											</div>
										</div>
									</fieldset>
								</div>
								...
								<div class="col-md-6">
									<fieldset>
					                	<legend class="font-weight-semibold"><i class="icon-truck mr-2"></i> Detalles Adicionales</legend>

										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Ingresa tu nombre de Usuario:</label>
											<div class="col-lg-9">
												<div class="row">
													<div class="col-md-6">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input type="text" placeholder="matricula@upv.edu.mx" class="form-control">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
												<input type="text" placeholder="834-22-2222" class="form-control">
											</div>
										</div>
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Referencias:</label>
											<div class="col-lg-9">
												<input type="text" placeholder="Referencias de la vivienda" class="form-control">
											</div>
										</div>

										<div class="form-group row">
											<label class="col-lg-3 col-form-label">Comentarios Adicionales:</label>
											<div class="col-lg-9">
							...
							<div class="text-right">
								<button type="submit" class="btn btn-primary">Listo <i class="icon-paperplane ml-2"></i></button>
							</div>
						</form>
					</div>
				</div>
