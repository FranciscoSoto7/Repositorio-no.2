			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Datatables</span> - Advanced</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Cuatrimestres</h5>
					...
					<table class="table datatable-show-all">
						...
						<tbody>
							...
							<tr>
								<td>Introducción a las Tecnologías de Información</td>
							...
							<tr>
								<td>Expresión Oral y Escrita l</td>
							...
							<tr>
								<td>Inglés l</td>
								<td>Matemáticas Básicas para Computación</td>
								<td>Mantenimiento a Equipo de Cómputo</td>
								<td></td>
