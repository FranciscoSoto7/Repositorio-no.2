			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Maestros</span> - Registrar/Editar</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="components_modals.html" class="breadcrumb-item">Maestros</a>
							<span class="breadcrumb-item active">Registrar/Editar</span>
						</div>
					...
					<div class="table-responsive">
						<table class="table">
							<tbody>
								<tr>
									<td></td>
									<td><button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_scrollable">Editar <i class="icon-play3 ml-2"></i></button></td>
									<td>Presiona el icono para Editar un Maestro</td>
								</tr>								
					...
					<div class="modal-dialog modal-dialog-scrollable">
						<div class="modal-content">
							<div class="modal-header pb-3">
								<h5 class="modal-title">Rellena los campos a Editar</h5>
							...
							<div class="modal-body py-0">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="Aura">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="password" class="form-control" placeholder="Hard">
										</div>
									</div>						
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="password" class="form-control" placeholder="haurahard0123">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="password" class="form-control" placeholder="haura_hd@hotmail.com">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="password" class="form-control" placeholder="16 Anaya">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="password" class="form-control" placeholder="27">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="password" class="form-control" placeholder="Mujer">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="password" class="form-control" placeholder="$10,000">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="password" class="form-control" placeholder="8347771290">
										</div>
									</div>
								<p></p>
							</div>
							...
							<div class="modal-footer pt-3">
								...
								<button type="button" class="btn bg-primary">Listo</button>
