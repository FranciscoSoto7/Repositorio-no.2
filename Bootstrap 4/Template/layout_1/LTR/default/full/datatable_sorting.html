			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold"></span> Transporte</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_sorting.html" class="breadcrumb-item">Transporte</a>
				...
				<!-- Default ordering -->
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title">TRANSPAIS</h5>
							...
							<div class="card-body">
								<form action="#">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="1900000">
									</div>

									<div class="form-group">
										<label>Nombre completo:</label>
										<input type="password" class="form-control" placeholder="Nombre y Apellidos">
									</div>


									<div class="form-group">
										<label class="d-block">Horario:</label>
									...
									<div class="form-group">
										<label>Carrera:</label>
										<input type="password" class="form-control" placeholder="ITI,ISA,MECA..">
									</div>

									<div class="form-group">
										<label>Fecha de Pago:</label>
										<input type="password" class="form-control" placeholder="Fecha Limite 20/10/2019">
									</div>


									<div class="form-group">
										<label class="d-block">Ruta:</label>
									...
									<div class="text-right">
										<button type="submit" class="btn btn-primary">Reservar <i class="icon-paperplane ml-2"></i></button>
									</div>
								</form>
							</div>
						</div>
